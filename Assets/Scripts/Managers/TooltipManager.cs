...
public class TooltipManager : MonoBehaviour
{
    ...
    public GameObject CompositeTooltipUI;
    ...
    [Header("Composite Tooltip")]
    public TextMeshProUGUI compositeInteraction;
    public Image upIcon;
    public Image downIcon;
    public Image leftIcon;
    public Image rightIcon;
    public TextMeshProUGUI compositeAction;
    ...
    {
        compositeInteraction.text = tooltip.interaction;
        upIcon.sprite = tooltip.upIcon;
        downIcon.sprite = tooltip.downIcon;
        leftIcon.sprite = tooltip.leftIcon;
    ...
    public Sprite GetKeyboardAndMouseSprite(string controlPath)
    {
        ...
        switch (controlPath)
        {
            ...
            case "<Keyboard>/numpadPlus": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Plus-Filled@4x"); 
            case "<Keyboard>/numpadPeriod": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Punctuation-Filled@4x");
            case "<Keyboard>/numpadMultiply": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Asterisk-Filled@4x");
            case "<Keyboard>/numpadDivide": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Slash-Filled@4x");
            case "<Keyboard>/numpadMinus": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Minus-Filled@4x");

            // function keys
            case "<Keyboard>/f1": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F1-Filled@4x");
            case "<Keyboard>/f2": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F2-Filled@4x");
            case "<Keyboard>/f3": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F3-Filled@4x");
            case "<Keyboard>/f4": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F4-Filled@4x");
            case "<Keyboard>/f5": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F5-Filled@4x");
            case "<Keyboard>/f6": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F6-Filled@4x");
            case "<Keyboard>/f7": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F7-Filled@4x");
            case "<Keyboard>/f8": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F8-Filled@4x");
            case "<Keyboard>/f9": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F9-Filled@4x");
            case "<Keyboard>/f10": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F10-Filled@4x");
            case "<Keyboard>/f11": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F11-Filled@4x");
            case "<Keyboard>/f12": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/F12-Filled@4x");
            ...
            case "<Keyboard>/backslash": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Backslash-Filled@4x");
            ...
            case "<Keyboard>/end": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/End-Filled@4x"); 
            ...
            case "<Keyboard>/home": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Home-Filled@4x"); 
            case "<Keyboard>/insert": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Insert-Filled@4x"); 
            case "<Keyboard>/minus": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Minus-Filled@4x");
            case "<Keyboard>/pageDown": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/PageDown-Filled@4x"); 
            case "<Keyboard>/pageUp": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/PageUp-Filled@4x");
            ...
            case "<Keyboard>/space": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Space-Filled@4x");
            case "<Keyboard>/tab": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Keyboard PNG/Filled/Tab-Filled@4x");

            // MOUSE
            case "<Mouse>/leftButton": return Resources.Load<Sprite>("Icons/Keyboard And Mouse/Mouse PNG/Filled/MouseLeftButton-Filled@4x"); 
            case "<Mouse>/rightButton": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Mouse PNG/Filled/MouseRightButton-Filled@4x");
            case "<Mouse>/middleButton": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Mouse PNG/Filled/MouseMiddleButton-Filled@4x");
            case "<Mouse>/forwardButton": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Mouse PNG/Filled/MouseLeft-Filled@4x");
            case "<Mouse>/backButton": return Resources.Load<Sprite>("Icons/Keyboard and Mouse/Mouse PNG/Filled/MouseLeft-Filled@4x");
    ...
    public Sprite GetPlaystationSprite(string controlPath)
    {
        ...
        switch (controlPath)
        {
            ...
            case "<Gamepad>/rightShoulder": return Resources.Load<Sprite>("Icons/Playstation/PS4_R1"); 
            case "<Gamepad>/leftShoulder": return Resources.Load<Sprite>("Icons/Playstation/PS4_L1");
            ...
            case "<Gamepad>/dpad": return Resources.Load<Sprite>("Icons/Playstation/PS4_Dpad");

            // start/pause/share buttons
            case "<Gamepad>/start": return Resources.Load<Sprite>("Icons/Playstation/PS4_Share");
            case "<Gamepad>/select": return Resources.Load<Sprite>("Icons/Playstation/PS4_Options");
        }
        return null;
    }
    ...
    public Sprite GetXboxSprite(string controlPath)
    {
        ...
        switch (controlPath)
        {
            ...
            case "<Gamepad>/rightShoulder": return Resources.Load<Sprite>("Icons/Xbox/XboxOne_RB"); 
            case "<Gamepad>/leftShoulder": return Resources.Load<Sprite>("Icons/Xbox/XboxOne_LB");
            ...
            case "<Gamepad>/buttonNorth": return Resources.Load<Sprite>("Icons/Xbox/XboxOne_Y");
            ...
            case "<Gamepad>/dpad": return Resources.Load<Sprite>("Icons/Xbox/XboxOne_Dpad");

            // start/pause/share buttons
            case "<Gamepad>/start": return Resources.Load<Sprite>("Icons/Xbox/XboxOne_Menu");
            case "<Gamepad>/select": return Resources.Load<Sprite>("Icons/Xbox/XboxOne_Windows");
        }
        return null;
    }
